...
public class TestRelationshipHistorySearch extends OpenMetadataPerformanceTestCase
{
    ...
    private static final String TEST_CASE_ID   = "repository-relationship-search-history-performance";
    private static final String TEST_CASE_NAME = "Repository relationship search performance test case against history";

    private static final String A_FIND_RELATIONSHIPS_ALL     = TEST_CASE_ID + "-findRelationships-all";
    private static final String A_FIND_RELATIONSHIPS_ALL_MSG = "Repository performs historical search of all instances, sorting by GUID and paging all results, of type: ";
    ...
    public TestRelationshipHistorySearch(PerformanceWorkPad workPad,
                                         ...
                                         Date               asOfTime)
    {
        super(workPad, PerformanceProfile.RELATIONSHIP_HISTORY_SEARCH.getProfileId());
    ...
    protected void run() throws Exception
    {
        ...
        super.setSuccessMessage("Relationship historical search performance tests complete for: " + testTypeName);
    }

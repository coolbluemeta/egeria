 ...
 * Connector Provider
 */
public class MetadataAccessServerProvider extends OpenConnectorProviderBase
{
    /*
    ...
    {
        super(EgeriaOpenConnectorDefinition.METADATA_ACCESS_SERVER_RESOURCE_CONNECTOR,
              connectorClassName,

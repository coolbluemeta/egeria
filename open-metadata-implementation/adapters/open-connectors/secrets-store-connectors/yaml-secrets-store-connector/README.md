...
The *YAML File Secrets Store Connector* is a [Secrets Store Connector](https://egeria-project.org/concepts/secrets-store-connector/) that retrieves secrets from a YAML file.
...
![Figure 1](docs/yaml-file-secrets-store-connector.png)

...
public enum WedgwoodProvisionSubscriptionRequestParameter
{
     ...
     */
    WedgwoodProvisionSubscriptionRequestParameter(String name,
                                                  String description,
                                                  String dataType,
                                                  String example)
    {
    ...
    public static List<RequestParameterType> getRequestParameterTypes()
    {
        ...
        for (WedgwoodProvisionSubscriptionRequestParameter requestParameter : WedgwoodProvisionSubscriptionRequestParameter.values())
        {

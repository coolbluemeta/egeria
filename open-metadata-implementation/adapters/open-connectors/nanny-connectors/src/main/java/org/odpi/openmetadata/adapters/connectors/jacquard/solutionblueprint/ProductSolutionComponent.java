...
/**
 * A description of the predefined solution components.  Any that are associated
 * with connectors will be created in one of the core content packs, which
 * is why the GUID is defined here.
 */
public enum ProductSolutionComponent
{
    JACQUARD_HARVESTER("3bd61f93-2aca-443d-84cf-330cd50a0c1d",
    ...
    METADATA_ACCESS_STORE(EgeriaDeployedImplementationType.METADATA_ACCESS_STORE.getSolutionComponentGUID(),
                          SolutionComponentType.DATA_STORAGE.getSolutionComponentType(),
                          null,
     ...
     * @param displayName            display name of the solution component
     * @param description            description of the solution component
    ...
    /**
     * Return the version identifier of the solution component.
     *
     * @return string
     */

 ...
 */
public enum WedgwoodProvisionSubscriptionGuard
{
    PROVISIONING_COMPLETE("provisioning-complete", CompletionStatus.ACTIONED, "The provisioning request completed successfully with no errors."),
    PROVISIONING_NO_TARGETS("provisioning-has-no-targets", CompletionStatus.INVALID, "The provisioning request has been made without supplying the source or destination action target."),
     ...
     */
    WedgwoodProvisionSubscriptionGuard(String name, CompletionStatus completionStatus, String description)
    {
        this.name             = name;
    ...
    public static List<GuardType> getGuardTypes()
    {
        ...
        for (WedgwoodProvisionSubscriptionGuard guard : WedgwoodProvisionSubscriptionGuard.values())
        {

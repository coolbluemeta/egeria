 ...
 */
public class PostgresServerCatalogTargetProcessor extends CatalogTargetProcessorBase
{
     ...
     */
    public PostgresServerCatalogTargetProcessor(CatalogTarget        catalogTarget,
    ...
    private String getFriendshipGUID(Map<String, Object> configurationProperties)
    {
        ...
        {
            friendshipGUID = this.getConfigurationProperties().get(PostgresConfigurationProperty.FRIENDSHIP_GUID.getName()).toString();
        }

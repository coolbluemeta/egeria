 ...
 */
public enum PostgresSolutionComponentActor implements SolutionComponentActorDefinition
{

    USER_TO_SERVER_SURVEY(EgeriaRoleDefinition.OPEN_METADATA_USER,
                     PostgresSolutionComponent.SURVEY_POSTGRES_SERVER,
                     "requests survey",
    ...
    USER_TO_DATABASE_SURVEY(EgeriaRoleDefinition.OPEN_METADATA_USER,
                          PostgresSolutionComponent.SURVEY_POSTGRES_DATABASE,
                          "requests survey",
    ...
    USER_TO_CATALOG_SERVER(EgeriaRoleDefinition.OPEN_METADATA_USER,
                      PostgresSolutionComponent.CATALOG_POSTGRES_SERVER,
    ...
    USER_TO_CATALOG_DATABASE(EgeriaRoleDefinition.OPEN_METADATA_USER,
                           PostgresSolutionComponent.CATALOG_POSTGRES_DATABASE,
                           "configures connector",
    ...
    PostgresSolutionComponentActor(EgeriaRoleDefinition        solutionRole,

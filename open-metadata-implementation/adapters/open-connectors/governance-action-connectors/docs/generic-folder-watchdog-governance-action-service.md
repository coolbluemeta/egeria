...
This connector uses the [Governance Action OMES](https://egeria-project.org/services/omes/governance-action) running in the [engine host](https://egeria-project.org/concepts/engine-host).

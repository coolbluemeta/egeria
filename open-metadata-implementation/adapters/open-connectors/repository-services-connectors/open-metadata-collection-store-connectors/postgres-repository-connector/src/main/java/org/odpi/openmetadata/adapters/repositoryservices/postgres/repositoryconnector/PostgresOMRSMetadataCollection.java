...
/**
 * The PostgresOMRSMetadataCollection represents a metadata repository that supports a repository that stores the
 * open metadata instances in a PostgreSQL database.  Each repository has the same table design, located
 * in its own database schema.
 */
public class PostgresOMRSMetadataCollection extends OMRSDynamicTypeMetadataCollectionBase
{
     ...
     */
    protected PostgresOMRSMetadataCollection(PostgresOMRSRepositoryConnector parentConnector,
                                             ...
                                             String                          metadataCollectionId)
    {
         ...
         */
        this.repositoryStore = new PostgresOMRSMetadataStore(repositoryName,
                                                             repositoryHelper,
                                                                ...
                                                                UserNotAuthorizedException
    {
        ...
        if (entity == null)
        {
            EntityProxy entityProxy = repositoryStore.getEntityProxy(guid, null);
                                                                     ...
                                                                     UserNotAuthorizedException
    {
         ...
         * Perform operation
         */
        EntityDetail  entity = repositoryStore.getEntity(guid, asOfTime);
        if (entity == null)
        {
            EntityProxy  entityProxy = repositoryStore.getEntityProxy(guid, asOfTime);
    ...
    public  List<EntityDetail> findEntitiesByPropertyValue(String                userId,
                                                           String                entityTypeGUID,
                                                           String searchString,
                                                           boolean startsWith, boolean endsWith, boolean ignoreCase, int                   fromEntityElement,
                                                           List<InstanceStatus>  limitResultsByStatus,
                                                           List<String>          limitResultsByClassification,
                                                           Date                  asOfTime,
                                                           String                sequencingProperty,
                                                                                                  ...
                                                                                                  UserNotAuthorizedException
    {
         ...
         * Process operation
         */
        return repositoryStore.findEntitiesByPropertyValue(entityTypeGUID, searchString, startsWith, endsWith, ignoreCase, fromEntityElement, limitResultsByStatus, limitResultsByClassification, asOfTime, sequencingProperty, sequencingOrder, pageSize);
    }
                                                                                                           ...
                                                                                                           UserNotAuthorizedException
    {
         ...
         * Perform operation
         */
        return repositoryStore.findRelationshipsByPropertyValue(relationshipTypeGUID, searchString, startsWith, endsWith, ignoreCase, fromRelationshipElement, limitResultsByStatus, asOfTime, sequencingProperty, sequencingOrder, pageSize);
    }
                                                                                   ...
                                                                                   FunctionNotSupportedException
    {
        ...
        return repositoryStore.addEntityToStore(newEntity);
    }
                                                                                       ...
                                                                                       FunctionNotSupportedException
    {
        ...
        try
        {
            ...
            return repositoryStore.addEntityToStore(updatedEntity);
        }
        catch (EntityProxyOnlyException proxyOnlyException)
        {
            super.reportEntityNotKnown(entityGUID, methodName, proxyOnlyException);
        }
                                                                    ...
                                                                    FunctionNotSupportedException
    {
        ...
        try
        {
            ...
            EntityDetail restoredEntity = repositoryStore.retrievePreviousVersionOfEntity(currentEntity);
            ...
            if (restoredEntity != null)
            {
                ...
                return repositoryStore.addEntityToStore(restoredEntity);
            }
            else
            {
                return null;
                                                                            ...
                                                                            FunctionNotSupportedException
    {
                        ...
                        if (relationship != null)
                        {
                            ...
                            if (type != null)
                            {
                                if ((metadataCollectionId.equals(relationship.getMetadataCollectionId())) ||
                                        (metadataCollectionId.equals(relationship.getReplicatedBy())))
                                {
                                ...
                                {
                                    repositoryStore.purgeRelationshipFromStore(relationship.getGUID());
                                }
                            }
                        }
                    }
        ...
        {
            super.reportEntityNotKnown(obsoleteEntityGUID, methodName, proxyOnlyException);
        }
                                                                ...
                                                                FunctionNotSupportedException
    {
        ...
        {
            super.reportEntityNotKnown(deletedEntityGUID, methodName, proxyOnlyException);
        }
    }
                                                                                             ...
                                                                                             FunctionNotSupportedException
    {
        ...
        try
        {
             ...
             */
            repositoryStore.saveClassification(entityGUID, newClassification);

            return repositoryHelper.addClassificationToEntity(repositoryName,
                                                              entity,
                                                              newClassification,
                                                              methodName);
        }
                                                                                               ...
                                                                                               FunctionNotSupportedException
    {
        ...
        try
        {
            EntitySummary entity = repositoryStore.getEntity(entityGUID, null);
            if (entity == null)
            {
                repositoryStore.addEntityProxyToStore(entityProxy);
                entity = repositoryStore.getEntityProxy(entityGUID, null);
            }
                                                                            ...
                                                                            FunctionNotSupportedException
    {
        ...
        try
        {
            ...
            return repositoryHelper.deleteClassificationFromEntity(repositoryName,
                                                                   entity,
                                                                   classificationName,
                                                                   methodName);
        }
                                                                                  ...
                                                                                  FunctionNotSupportedException
    {
        ...
        repositoryHelper.incrementVersion(userId, classification, newClassification);
        repositoryStore.saveClassification(entityProxy.getGUID(), newClassification);
                                                                                           ...
                                                                                           FunctionNotSupportedException
    {
        ...
        try
        {
            ...
            return repositoryHelper.updateClassificationInEntity(repositoryName,
                                                                 userId,
                                                                 entity,
                                                                 newClassification,
                                                                 methodName);
                                                                                   ...
                                                                                   FunctionNotSupportedException
    {
         ...
         */
        EntityProxy entityOneProxy = repositoryStore.getEntityProxy(entityOneGUID, null);
         ...
         */
        EntityProxy entityTwoProxy = repositoryStore.getEntityProxy(entityTwoGUID, null);
        ...
        return repositoryStore.addRelationshipToStore(relationship);
    }
                                                                                             ...
                                                                                             FunctionNotSupportedException
    {
        ...
        return repositoryStore.addRelationshipToStore(updatedRelationship);
    }
                                                                                ...
                                                                                FunctionNotSupportedException
    {
        ...
        Relationship restoredRelationship = repositoryStore.retrievePreviousVersionOfRelationship(currentRelationship);
        ...
        return repositoryStore.addRelationshipToStore(restoredRelationship);
    }
                                                                          ...
                                                                          FunctionNotSupportedException
    {
        ...
        try
        {
            ...
            repositoryStore.addEntityToStore(deletedEntity);
                                                                                      ...
                                                                                      FunctionNotSupportedException
    {
        ...
        repositoryStore.addRelationshipToStore(deletedRelationship);
                                                                                      ...
                                                                                      PropertyErrorException
    {
        ...
        EntityProxy retrievedEntity = repositoryStore.getEntityProxy(entity.getGUID(), null);
        ...
        if (retrievedEntity != null)
        {
            try
            {
                ...
                repositoryStore.saveClassification(entity.getGUID(),classification);
            }
                                                                                        ...
                                                                                        RepositoryErrorException
    {
        ...
        repositoryStore.removeClassificationFromEntity(entity.getGUID(), classification.getName());
    }
                                                                                        ...
                                                                                        FunctionNotSupportedException
    {
        ...
        repositoryStore.removeClassificationFromEntity(entityProxy.getGUID(), classification.getName());
    }

 ...
 *         metadata repository (where the creation and all subsequent updates happen) maintains the version number.
 *     </li>
 *     <li>
 ...
 *         metadata that change this value.  For example, it switches to deleted when the instance is deleted.
 *     </li>
 *     <li>
 ...
 *         called - it is used to set the status if the instance is restored.
 *     </li>
 *     <li>
 ...
 *         home repository and stored by any other repository saving a reference copy.
 *     </li>
 * </ul>
 *
 */

...
/**
 * TypeDefGalleryRequest provides the request structure for an OMRS REST API call that passes a TypeDefGallery.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class TypeDefGalleryRequest extends OMRSAPIRequest
{
     ...
     */
    public TypeDefGalleryRequest(TypeDefGalleryRequest template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof TypeDefGalleryRequest that))
        {
            return false;
        }

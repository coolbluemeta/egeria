...
public class AttributeTypeDefRequest extends OMRSAPIRequest
{
     ...
     * Default constructor
     */
    public AttributeTypeDefRequest()
    {
        super();
    }
     ...
     */
    public AttributeTypeDefRequest(AttributeTypeDefRequest template)
    {
        super(template);
    ...
    {
        return "AttributeTypeDefRequest{" +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof AttributeTypeDefRequest that))
        {
            return false;
        }

...
/**
 * RelationshipRequest describes the response to an OMRS REST API request that returns a relationship object.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class RelationshipRequest extends OMRSAPIRequest
{
     ...
     */
    public RelationshipRequest(RelationshipRequest template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof RelationshipRequest that))
        {
            return false;
        }

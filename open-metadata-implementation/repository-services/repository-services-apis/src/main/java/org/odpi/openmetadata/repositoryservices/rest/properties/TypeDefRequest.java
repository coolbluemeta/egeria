...
/**
 * TypeDefRequest provides the request structure for an OMRS API call that passes a TypeDef
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class TypeDefRequest extends OMRSAPIRequest
{
     ...
     */
    public TypeDefRequest(TypeDefRequest template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (!(objectToCompare instanceof TypeDefRequest that))
        {
            return false;
        }

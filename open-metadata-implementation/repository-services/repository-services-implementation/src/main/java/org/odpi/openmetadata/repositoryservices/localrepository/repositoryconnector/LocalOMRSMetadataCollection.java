...
public class LocalOMRSMetadataCollection extends OMRSMetadataCollectionBase
{
                                                                                                        ...
                                                                                                        UserNotAuthorizedException
    {
         ...
         * Perform operation
         */
        List<Classification> history = realMetadataCollection.getClassificationHistory(userId, guid, classificationName, fromTime, toTime, startFromElement, pageSize, sequencingOrder);

        setLocalProvenanceInEntityClassifications(history);
                                                                                                           ...
                                                                                                           UserNotAuthorizedException
    {
        ...
        List<Relationship> resultList = realMetadataCollection.findRelationshipsByPropertyValue(userId,
                                                                                                ...
                                                                                                searchString,
                                                                                                startsWith,
                                                                                                endsWith, ignoreCase, fromRelationshipElement,
                                                                                                limitResultsByStatus,
                                                                                                asOfTime,
                                                                                                sequencingProperty,
                                                                                                sequencingOrder,

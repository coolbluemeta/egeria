...
public class ProjectClassificationProperties extends ClassificationBeanProperties
{
     ...
     * Default constructor
     */
    public ProjectClassificationProperties()
    {
        super();
        super.typeName = OpenMetadataType.PROJECT_CLASSIFICATION_CLASSIFICATION.typeName;
    }
     ...
     */
    public ProjectClassificationProperties(ProjectClassificationProperties template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof ProjectClassificationProperties that))
        {
            return false;
        }

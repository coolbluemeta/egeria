...
public class ReportOriginatorProperties extends LabeledRelationshipProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public ReportOriginatorProperties(ReportOriginatorProperties template)
    {
        super(template);
    }
    ...
    {
        return "ReportOriginatorProperties{} " + super.toString();
    }
}

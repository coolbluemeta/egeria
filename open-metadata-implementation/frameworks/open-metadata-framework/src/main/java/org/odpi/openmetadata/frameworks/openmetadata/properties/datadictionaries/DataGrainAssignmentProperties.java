...
/**
 * DataGrainAssignmentProperties links an element to a data grain to indicate that the data grain describes its granularity.
 */
@JsonAutoDetect(getterVisibility = PUBLIC_ONLY, setterVisibility = PUBLIC_ONLY, fieldVisibility = NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class DataGrainAssignmentProperties extends LabeledRelationshipProperties
{
     ...
     * Default constructor
     */
    public DataGrainAssignmentProperties()
    {
        super();
        super.typeName = OpenMetadataType.DATA_GRAIN_ASSIGNMENT_RELATIONSHIP.typeName;
    }
     ...
     */
    public DataGrainAssignmentProperties(DataGrainAssignmentProperties template)
    {
        super(template);
    ...
    {
        return "DataGrainAssignmentProperties{" +
                "method='" + method + '\'' +
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof DataGrainAssignmentProperties that))
        {
            return false;
        }

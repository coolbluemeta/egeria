...
public class DataClassCompositionProperties extends LabeledRelationshipProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public DataClassCompositionProperties(DataClassCompositionProperties template)
    {
        super(template);
    }
    ...
    {
        return "DataClassCompositionProperties{} " + super.toString();
    }
}

...
/**
 * ScopingCollectionProperties is used to provide the properties for a ScopingCollection classification.
 */
@JsonAutoDetect(getterVisibility = PUBLIC_ONLY, setterVisibility = PUBLIC_ONLY, fieldVisibility = NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class ScopingCollectionProperties extends CollectionKindProperties
{

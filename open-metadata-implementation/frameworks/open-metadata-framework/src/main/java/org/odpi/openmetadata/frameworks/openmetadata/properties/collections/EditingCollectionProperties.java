...
public class EditingCollectionProperties extends CollectionKindProperties
{
     ...
     */
    public EditingCollectionProperties(EditingCollectionProperties template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        if (! (objectToCompare instanceof EditingCollectionProperties that))
        {
            return false;
        }

...
public enum ByteOrdering implements OpenMetadataEnum
{
     ...
     */
    BIG_ENDIAN     (0,  "a803158c-f178-4867-b634-1c02755b7d4a",  "BigEndian",    "Bits or bytes order from the big end.", false),

    /**
     * Bits or bytes ordered from the little end.
     */
    LITTLE_ENDIAN  (1,  "645a85ba-2c11-42f3-8e84-bf8520b97798",  "LittleEndian", "Bits or bytes ordered from the little end.", true);

    private static final String ENUM_TYPE_GUID  = "e5612c3a-49bd-4148-8f67-cfdf145d5fd8";
    private static final String ENUM_TYPE_NAME  = "ByteOrdering";
    ...
    private static final String ENUM_DESCRIPTION_GUID = "81bc8b88-ee80-493f-9f32-66c65d2b1f46";
    private static final String ENUM_DESCRIPTION_WIKI = OpenMetadataWikiPages.MODEL_0030_OPERATING_PLATFORMS;

...
public class ValidValueDefinitionClient extends ConnectorContextClientBase
{
                                                                                                   ...
                                                                                                   UserNotAuthorizedException
    {
        ...
        newElementOptions.setAnchorScopeGUIDs(Collections.singletonList(validValueSetGUID));
     ...
     * @throws UserNotAuthorizedException the requesting user is not authorized to issue this request.
     */
    public boolean updateValidValueDefinition(String                 validValueDefinitionGUID,

...
/**
 * ReportedAnnotationProperties is used to link a new annotation to the survey report representing the survey that
 * created the annotation.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class ReportedAnnotationProperties extends LabeledRelationshipProperties
{
    /**
    ...
    {
        return "ReportedAnnotationProperties{} " + super.toString();
    }
}

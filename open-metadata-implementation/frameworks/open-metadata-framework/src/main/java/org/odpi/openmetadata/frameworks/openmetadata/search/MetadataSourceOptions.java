...
/**
 * Provides the parameters for marking an element, classification, or relationship as external
 * and for working with lineage/duplicate processing and effective time.
 */
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
public class MetadataSourceOptions extends BasicOptions
{
     ...
     */
    public MetadataSourceOptions(MetadataSourceOptions template)
    {
        super(template);
    ...
    public boolean equals(Object objectToCompare)
    {
        ...
        MetadataSourceOptions that = (MetadataSourceOptions) objectToCompare;

...
public class ReportSubjectProperties extends LabeledRelationshipProperties
{
    /**
     * Default constructor
     */
     ...
     */
    public ReportSubjectProperties(ReportSubjectProperties template)
    {
        super(template);
    }
    ...
    {
        return "ReportSubjectProperties{} " + super.toString();
    }
}

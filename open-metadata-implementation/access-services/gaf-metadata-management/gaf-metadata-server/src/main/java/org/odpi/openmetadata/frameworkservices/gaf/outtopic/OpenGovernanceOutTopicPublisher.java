...
package org.odpi.openmetadata.frameworkservices.gaf.outtopic;
...
/**
 * OpenGovernanceOutTopicPublisher sends events on the Open Governance's out topic.
 * It is called from the Open Governances's OMRS Topic Listener.
 */
public class OpenGovernanceOutTopicPublisher
{
    private final GAFOutTopicServerConnector            outTopicServerConnector;
     ...
     */
    public OpenGovernanceOutTopicPublisher(GAFOutTopicServerConnector outTopicServerConnector,
                                           String                     outTopicName,
                                           ...
                                           String                     serverName)
    {
        ...
        {
            outTopicAuditLog.logMessage(actionDescription, OpenGovernanceAuditCode.SERVICE_PUBLISHING.getMessageDefinition(outTopicName));
        }
    }
